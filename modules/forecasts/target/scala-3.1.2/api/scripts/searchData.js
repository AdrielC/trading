...
{"l":"trading/forecasts/Config$.html","n":"load","t":"def load[F[_]](using evidence$1: Async[F]): F[ForecastsConfig]","d":"trading/forecasts/Config$","k":"def"},
...
{"l":"trading/forecasts/Engine$.html","n":"make","t":"def make[F[_]](authors: Producer[F, AuthorEvent], forecasts: Producer[F, ForecastEvent], atStore: AuthorStore[F], fcStore: ForecastStore[F], acker: Acker[F, ForecastCommand])(using evidence$1: GenUUID[F], evidence$2: Logger[F], evidence$3: MonadThrow[F], evidence$4: Time[F]): Engine[F]","d":"trading/forecasts/Engine$","k":"def"},
...
{"l":"trading/forecasts/store.html","n":"onConstraintViolation","t":"def onConstraintViolation(err: Throwable)(using evidence$2: MonadThrow[F]): F[A]","d":"trading/forecasts/store","k":"def"},
{"l":"trading/forecasts/store.html","n":"onDuplicate","t":"def onDuplicate(err: Throwable)(using evidence$1: MonadThrow[F]): F[A]","d":"trading/forecasts/store","k":"def"},
{"l":"trading/forecasts/store.html","n":"onUpdateFailure","t":"def onUpdateFailure(err: Throwable)(using evidence$3: MonadThrow[F]): F[Unit]","d":"trading/forecasts/store","k":"def"},
...
{"l":"trading/forecasts/store/AuthorStore$.html","n":"from","t":"def from[F[_]](xa: Transactor[F])(using evidence$1: MonadCancelThrow[F]): AuthorStore[F]","d":"trading/forecasts/store/AuthorStore$","k":"def"},
{"l":"trading/forecasts/store/DB$.html","n":"DB","t":"object DB","d":"trading/forecasts/store/DB$","k":"object"},
{"l":"trading/forecasts/store/DB$.html","n":"init","t":"def init[F[_]](using evidence$1: Async[F]): Resource[F, H2Transactor[F]]","d":"trading/forecasts/store/DB$","k":"def"},
...
{"l":"trading/forecasts/store/ForecastStore$.html","n":"from","t":"def from[F[_]](xa: Transactor[F])(using evidence$1: MonadCancelThrow[F]): ForecastStore[F]","d":"trading/forecasts/store/ForecastStore$","k":"def"},
