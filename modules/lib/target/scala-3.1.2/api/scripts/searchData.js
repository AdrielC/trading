...
{"l":"trading/lib.html","n":"lift","t":"def lift[E <: Throwable](using evidence$2: MonadThrow[F], evidence$3: ClassTag[E]): F[Either[E, A]]","d":"trading/lib","k":"def"},
{"l":"trading/lib.html","n":"liftU","t":"def liftU[E <: Throwable](using evidence$4: MonadThrow[F], evidence$5: ClassTag[E]): F[E | A]","d":"trading/lib","k":"def"},
{"l":"trading/lib.html","n":"onFirstMessage","t":"def onFirstMessage(action: F[Unit]): Stream[F, A]","d":"trading/lib","k":"def"},
{"l":"trading/lib.html","n":"rethrowU","t":"def rethrowU(using evidence$6: MonadThrow[F]): F[A]","d":"trading/lib","k":"def"},
{"l":"trading/lib.html","n":"rewind","t":"def rewind(id: MsgId, gate: Deferred[F, Unit])(using evidence$1: Monad[F]): Stream[F, Msg[A]]","d":"trading/lib","k":"def"},
...
{"l":"trading/lib/Compaction$.html","n":"apply","t":"def apply[A](using evidence$1: Compaction[A]): Compaction[A]","d":"trading/lib/Compaction$","k":"def"},
...
{"l":"trading/lib/Consumer$.html","n":"kafka","t":"def kafka[F[_], A](settings: ConsumerSettings[F, String, A], topic: String)(using evidence$6: Async[F]): Resource[F, Consumer[F, A]]","d":"trading/lib/Consumer$","k":"def"},
{"l":"trading/lib/Consumer$.html","n":"local","t":"def local[F[_], A](queue: Queue[F, Option[A]])(using evidence$1: Applicative[F]): Consumer[F, A]","d":"trading/lib/Consumer$","k":"def"},
{"l":"trading/lib/Consumer$.html","n":"pulsar","t":"def pulsar[F[_], A](client: T, topic: Topic, sub: Subscription, settings: Option[Settings[F, A]])(using evidence$2: Async[F], evidence$3: Logger[F], evidence$4: Decoder[A], evidence$5: Encoder[A]): Resource[F, Consumer[F, A]]","d":"trading/lib/Consumer$","k":"def"},
...
{"l":"trading/lib/DistLock$.html","n":"from","t":"def from[F[_]](lockName: String, appId: AppId, redis: RedisCommands[F, String, String])(using evidence$4: Logger[F], evidence$5: Temporal[F]): Resource[F, DistLock[F]]","d":"trading/lib/DistLock$","k":"def"},
{"l":"trading/lib/DistLock$.html","n":"make","t":"def make[F[_]](lockName: String, appId: AppId, client: RedisClient)(using evidence$1: Logger[F], evidence$2: MkRedis[F], evidence$3: Temporal[F]): Resource[F, DistLock[F]]","d":"trading/lib/DistLock$","k":"def"},
...
{"l":"trading/lib/GenUUID.html","n":"make","t":"def make[A](using evidence$1: IsUUID[A]): F[A]","d":"trading/lib/GenUUID","k":"def"},
{"l":"trading/lib/GenUUID$.html","n":"GenUUID","t":"object GenUUID","d":"trading/lib/GenUUID$","k":"object"},
{"l":"trading/lib/GenUUID$.html","n":"apply","t":"def apply[F[_]](using evidence$2: GenUUID[F]): GenUUID[F]","d":"trading/lib/GenUUID$","k":"def"},
{"l":"trading/lib/GenUUID$.html","n":"given_GenUUID_F","t":"given given_GenUUID_F[F[_]](using evidence$3: Sync[F]): given_GenUUID_F[F]","d":"trading/lib/GenUUID$","k":"given"},
...
{"l":"trading/lib/Logger$.html","n":"apply","t":"def apply[F[_]](using evidence$1: Logger[F]): Logger[F]","d":"trading/lib/Logger$","k":"def"},
{"l":"trading/lib/Logger$.html","n":"from","t":"def from[F[_]](log: Logger[F]): Logger[F]","d":"trading/lib/Logger$","k":"def"},
{"l":"trading/lib/Logger$.html","n":"given_Logger_F","t":"given given_Logger_F[F[_]](using evidence$4: Sync[F]): Logger[F]","d":"trading/lib/Logger$","k":"given"},
{"l":"trading/lib/Logger$.html","n":"pulsar","t":"def pulsar[F[_], A](flow: \"in\" | \"out\")(using evidence$2: Logger[F], evidence$3: Encoder[A]): A => URL => F[Unit]","d":"trading/lib/Logger$","k":"def"},
...
{"l":"trading/lib/Logger$$NoOp$.html","n":"given_Logger_F","t":"given given_Logger_F[F[_]](using evidence$5: Applicative[F]): given_Logger_F[F]","d":"trading/lib/Logger$$NoOp$","k":"given"},
...
{"l":"trading/lib/Producer$.html","n":"dummy","t":"def dummy[F[_], A](using evidence$3: Applicative[F]): Producer[F, A]","d":"trading/lib/Producer$","k":"def"},
{"l":"trading/lib/Producer$.html","n":"kafka","t":"def kafka[F[_], A](settings: ProducerSettings[F, String, A], topic: String)(using evidence$11: Async[F]): Resource[F, Producer[F, A]]","d":"trading/lib/Producer$","k":"def"},
{"l":"trading/lib/Producer$.html","n":"local","t":"def local[F[_], A](queue: Queue[F, Option[A]])(using evidence$1: Applicative[F]): Resource[F, Producer[F, A]]","d":"trading/lib/Producer$","k":"def"},
{"l":"trading/lib/Producer$.html","n":"pulsar","t":"def pulsar[F[_], A](client: T, topic: Single, settings: Option[Settings[F, A]])(using evidence$7: Async[F], evidence$8: Logger[F], evidence$9: Parallel[F], evidence$10: Encoder[A]): Resource[F, Producer[F, A]]","d":"trading/lib/Producer$","k":"def"},
{"l":"trading/lib/Producer$.html","n":"test","t":"def test[F[_], A](ref: Ref[F, Option[A]])(using evidence$5: Applicative[F]): Producer[F, A]","d":"trading/lib/Producer$","k":"def"},
{"l":"trading/lib/Producer$.html","n":"testMany","t":"def testMany[F[_], A](ref: Ref[F, List[A]])(using evidence$4: Applicative[F]): Producer[F, A]","d":"trading/lib/Producer$","k":"def"},
...
{"l":"trading/lib/Shard$.html","n":"apply","t":"def apply[A](using evidence$1: Shard[A]): Shard[A]","d":"trading/lib/Shard$","k":"def"},
...
{"l":"trading/lib/Time$.html","n":"apply","t":"def apply[F[_]](using evidence$1: Time[F]): Time[F]","d":"trading/lib/Time$","k":"def"},
{"l":"trading/lib/Time$.html","n":"given_Time_F","t":"given given_Time_F[F[_]](using evidence$2: Sync[F]): given_Time_F[F]","d":"trading/lib/Time$","k":"given"},
